...
alias gansco='git annex sync --no-content --no-pull --no-push'
alias gansup='git annex sync --no-content --no-commit --no-push'
alias ganspu='git annex sync --no-content --no-commit --no-pull'
